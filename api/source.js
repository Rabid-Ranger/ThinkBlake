...
(() => {
  ...
  function installUi() {
    ...
    style.textContent = [
      ...
      '.ai-v2-try{display:flex;gap:10px;align-items:center;margin-top:14px;padding:12px;border:1px dashed #c8d2da;border-radius:13px;background:#f8fafb}.ai-v2-try code{min-width:0;flex:1;color:#46515c;font:600 12px/1.4 Inter,system-ui,sans-serif;white-space:normal}.ai-v2-mini-button{display:inline-flex;align-items:center;justify-content:center;flex:none;min-height:34px;border:1px solid #17212b;border-radius:9px;background:#17212b;color:#fff;padding:7px 10px;font:800 10px/1.2 Inter,system-ui,sans-serif;cursor:pointer;text-decoration:none}',
