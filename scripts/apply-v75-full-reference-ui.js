...
console.log(JSON.stringify({build:'V52.1-reference-ui-v75',cssCharacters:css.length,jsCharacters:js.length,sourceCharacters:source.length,wrapperCharacters:wrapper.length,checksums:expected},null,2));
