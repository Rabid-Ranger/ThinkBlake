(function(root,factory){
  ...
  function render(c,W,ADC,WF,guide){
    ...
    return '<section class="cg-native-section apb-shell" id="analytics-program-bridge">'+
      ...
      '<div class="apb-flow">'+
        '<div class="apb-step"><span>1 · DIAGNOSE</span><h3>'+esc(r.focus)+'</h3><p>'+esc(r.why)+'</p><small>Use SHOW → CLICK → WATCH → RETURN → RESULT to locate the layer. Do not force a bottleneck when the system looks healthy.</small></div>'+
